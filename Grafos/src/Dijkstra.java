...
public class Dijkstra {
    ...
    /**
     * Finds the shortest path considering the distance from the initial vertex to
     * the final vertex using Dijkstra's algorithm.
     *
     ...
     */
    public ShortestPath shortestPathByDistance(String initialVertexName, String finalVertexName) {
        ...
        while (!pq.isEmpty()) {
            ...
            if (neighbors != null) {
                ...
                for (Vertex neighbor : neighbors) {
                    ...
                    int edgeWeight = graph.getEdgeDistance(currentVertex, neighbor);
    ...
    /**
     * Prints the shortest path between two vertices along with the total distance.
     * <p>
     ...
     */
    public void printPathByDistance(String initialVertexName, String finalVertexName) {

        ShortestPath result = shortestPathByDistance(initialVertexName, finalVertexName);
    ...
    /**
     * Finds the shortest path considering the risk level of the vertices from the
     * initial vertex to the final vertex using
     ...
     *         weight, or null if any vertex is not found
     */
    public ShortestPath shortestPathByRisk(String initialVertexName, String finalVertexName) {
        ...
        while (!pq.isEmpty()) {
            ...
            if (neighbors != null) {
                ...
                for (Vertex neighbor : neighbors) {
                    ...
                    int edgeWeight = graph.getEdgeRisk(currentVertex, neighbor);
                    int newDistance = distances.get(currentVertex) + edgeWeight;
    ...
    /**
     * Prints the shortest path between two vertices along with the total risk
     * level.
     * <p>
     * Displays a message if the path does not exist.
     *
     ...
     * @param finalVertexName
     */
    public void printPathByRisk(String initialVertexName, String finalVertexName) {

        ShortestPath result = shortestPathByRisk(initialVertexName, finalVertexName);
        ...
        System.out.printf("# Safest path between [%s] and [%s]\n", initialVertexName, finalVertexName);

        for (Vertex v : result.getPath())
            System.out.printf("[%s] ", v.name);

        System.out.printf("Total Risk: %d\n", result.getTotalWeight());
